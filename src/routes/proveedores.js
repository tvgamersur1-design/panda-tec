...
router.post('/', auth, roles(['admin', 'almacen']), writeRateLimiter, proveedoresController.crear);

// PUT /api/proveedores/:id — editar proveedor
router.put('/:id', auth, roles(['admin', 'almacen']), writeRateLimiter, proveedoresController.editar);
